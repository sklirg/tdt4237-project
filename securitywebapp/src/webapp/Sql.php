...
class Sql
{
    ...
    static function up()
    {
        ...
        $q6 = "CREATE TABLE posts (postId INTEGER PRIMARY KEY AUTOINCREMENT, author TEXT, title TEXT NOT NULL, content TEXT NOT NULL, isAnsweredByDoctor INTEGER, date TEXT NOT NULL, FOREIGN KEY(author) REFERENCES users(user));";
    ...
    static function insertPosts() {
        ...
        $q5 = "INSERT INTO posts(author, date, title, content, isAnsweredByDoctor) VALUES ('bjarni', '26082015', 'I also have a problem', 'I generally fear very much for my health', 0);";
